...
const Skills = () => {
    ...
    return (
        <div className="h-[130vh] relative text-white flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col space-y-16">
                <div className="flex w-full justify-around items-end">
                    ...
                    <div className="flex space-x-3 ">
                        <button onClick={handlePrevious} className="flex rounded-full p-5 bg-[#2D343F] w-fit transition-all hover:scale-95 hover:bg-[#075FE4]">
                            <svg
                        ...
                        <button onClick={handleForward} className="flex rounded-full p-5 bg-[#075FE4] w-fit transition-transform hover:scale-95">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                width={35}
                ...
                <div className="flex space-x-8 items-center justify-center overflow-x-auto">
                    {currentSkills.map((skill, index) => (
                        <div
                            key={index}
                            className="w-[27rem] h-[30rem] rounded-[2rem] bg-[#2D343F] flex flex-col space-y-10 justify-center p-12 pt-16 items-start transition-all"
                        >
                            <div className="flex flex-col space-y-2.5 justify-center items-start">
                                ...
                                <span className="font-[700] text-[38px] leading-[46px]">
                                    {skill.name}
                                </span>
                                <span className="font-[400] leading-[38px] text-[24px] text-[#c3cad5]">
                                    {skill.description}
                                </span>
                            </div>
