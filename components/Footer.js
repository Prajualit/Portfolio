            ...
            <div className='flex xl:items-center items-center sm:items-start justify-around h-full p-16 xl:flex-row flex-col xl:space-y-0 space-y-10'>
                <div className='flex flex-col items-center xl:items-start space-y-6'>
                    ...
                    <div className='flex space-x-4 items-center'>
                        <Link href="https://x.com/tickoo_sahab">
                            <svg className='cursor-pointer transition-transform hover:-translate-y-2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={30} height={30} color={"black"} fill={"white"}>
                        ...
                        <Link href="https://github.com/Prajualit?tab=overview&from=2024-07-01&to=2024-07-25">
                            <svg className='cursor-pointer transition-transform hover:-translate-y-2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={33} height={33} color={"black"} fill={"white"}>
                ...
                <div className='flex flex-col space-y-7 md:w-[33rem]'>
                    <div className='font-[700] leading-[64px] text-[36px] xl:text-[52px] flex space-x-2 items-center'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={50} height={50} color={"#075fe4"} fill={"none"}>
