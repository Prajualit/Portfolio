...
<p>
    I'm Prajualit. I've been working in web development for over 2 years, doing both the coding you see on the screen (frontend) and the stuff that happens behind the scenes (backend). I know how to manage projects using methods like Waterfall and Agile. But what really gets me excited is making websites and apps that are easy for everyone to use and look good too!
</p>
<p>
    I'm really into JavaScript, which is the a language used to build websites. I also know a bunch of frameworks that make building websites even easier, like React, Next.js, Node.js, Nuxt.js and Nest.js. I love learning about new web tools and features.
</p>
<p>
