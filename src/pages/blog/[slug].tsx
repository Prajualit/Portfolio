...
const BlogDetailPage: NextPage<BlogDetailPageProps> = ({ blog }) => {
  ...
  const canonicalUrl = `https://prajualittickoo.vercel.app/${slug}`;
  ...
  return (
    <>
      <NextSeo
        title={`${blogData?.title?.rendered} - Blog Prajualit Tickoo`}
        ...
        openGraph={{
          ...
          article: {
            ...
            authors: ['Prajualit Tickoo', 'prickoos'],
          },
          url: canonicalUrl,
          images: [
            {
